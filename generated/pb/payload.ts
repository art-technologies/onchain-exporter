...
function _encodeMetadata(message: Metadata, bb: ByteBuffer): void {
...
export function decodeMetadata(binary: Uint8Array): Metadata {
  return _decodeMetadata(wrapByteBuffer(binary));
}

function _decodeMetadata(bb: ByteBuffer): Metadata {
  let message: Metadata = {} as any;

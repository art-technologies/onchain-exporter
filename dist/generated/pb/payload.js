...
exports.decodeParameter = exports.encodeParameter = exports.decodeMetadata = exports.encodeMetadata = void 0;
function encodeMetadata(message) {
    let bb = popByteBuffer();
    _encodeMetadata(message, bb);
    return toUint8Array(bb);
}
exports.encodeMetadata = encodeMetadata;
function _encodeMetadata(message, bb) {
...
function decodeMetadata(binary) {
    return _decodeMetadata(wrapByteBuffer(binary));
}
exports.decodeMetadata = decodeMetadata;
function _decodeMetadata(bb) {
    let message = {};
...
function encodeParameter(message) {
    let bb = popByteBuffer();
    _encodeParameter(message, bb);
    return toUint8Array(bb);
}
exports.encodeParameter = encodeParameter;
function _encodeParameter(message, bb) {

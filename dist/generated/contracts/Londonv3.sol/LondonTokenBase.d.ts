...
export interface LondonTokenBaseInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "_balances" | "_baseUri" | "_name" | "_owners" | "_payloads" | "addFile" | "approve" | "artistName" | "balanceOf" | "creator" | "fileContents" | "fileStorage" | "files" | "gatewayManager" | "getApproved" | "getPayload" | "initialize" | "isApprovedForAll" | "license" | "mint" | "mintBatch" | "mintBatchWithPayload" | "mintWithPayload" | "mintingManager" | "name" | "owner" | "ownerOf" | "projectDescription" | "removeFile" | "renounceOwnership" | "royaltyInfo" | "safeTransferFrom(address,address,uint256)" | "safeTransferFrom(address,address,uint256,bytes)" | "setApprovalForAll" | "setArtistName" | "setCollectionName" | "setDescription" | "setGatewayManager" | "setLicense" | "setMintingManager" | "setPayload" | "setRoyalties" | "setURI" | "setYear" | "supportsInterface" | "symbol" | "tokenURI" | "totalSupply" | "transferFrom" | "transferOwnership" | "year"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "_owners", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "_payloads", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "addFile", values: [string, string[]]): string;
    encodeFunctionData(functionFragment: "approve", values: [string, BigNumberish]): string;
    encodeFunctionData(functionFragment: "artistName", values?: undefined): string;
    encodeFunctionData(functionFragment: "balanceOf", values: [string]): string;
    encodeFunctionData(functionFragment: "creator", values?: undefined): string;
    encodeFunctionData(functionFragment: "fileContents", values: [string]): string;
    ...
    encodeFunctionData(functionFragment: "gatewayManager", values?: undefined): string;
    encodeFunctionData(functionFragment: "getApproved", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "getPayload", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "initialize", values: [string, string, string, string, BigNumberish, string]): string;
    encodeFunctionData(functionFragment: "isApprovedForAll", values: [string, string]): string;
    encodeFunctionData(functionFragment: "license", values?: undefined): string;
    encodeFunctionData(functionFragment: "mint", values: [string, BigNumberish]): string;
    encodeFunctionData(functionFragment: "mintBatch", values: [string[], BigNumberish[]]): string;
    encodeFunctionData(functionFragment: "mintBatchWithPayload", values: [string[], BigNumberish[], string[]]): string;
    encodeFunctionData(functionFragment: "mintWithPayload", values: [string, BigNumberish, string]): string;
    encodeFunctionData(functionFragment: "mintingManager", values?: undefined): string;
    encodeFunctionData(functionFragment: "name", values?: undefined): string;
    encodeFunctionData(functionFragment: "owner", values?: undefined): string;
    encodeFunctionData(functionFragment: "ownerOf", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "projectDescription", values?: undefined): string;
    ...
    encodeFunctionData(functionFragment: "setArtistName", values: [string]): string;
    encodeFunctionData(functionFragment: "setCollectionName", values: [string]): string;
    encodeFunctionData(functionFragment: "setDescription", values: [string]): string;
    encodeFunctionData(functionFragment: "setGatewayManager", values: [string]): string;
    encodeFunctionData(functionFragment: "setLicense", values: [string]): string;
    encodeFunctionData(functionFragment: "setMintingManager", values: [string]): string;
    encodeFunctionData(functionFragment: "setPayload", values: [BigNumberish, string]): string;
    encodeFunctionData(functionFragment: "setRoyalties", values: [string, BigNumberish]): string;
    ...
    decodeFunctionResult(functionFragment: "fileContents", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "fileStorage", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "files", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "gatewayManager", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "mintBatchWithPayload", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "mintWithPayload", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "mintingManager", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "name", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "owner", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "ownerOf", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "projectDescription", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "setArtistName", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "setCollectionName", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "setDescription", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "setGatewayManager", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "setLicense", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "setMintingManager", data: BytesLike): Result;
...
export interface LondonTokenBase extends BaseContract {
    ...
    functions: {
        ...
        addFile(fileName: string, fileStorageAddresses: string[], overrides?: Overrides & {
            from?: string;
        ...
        initialize(uri_: string, minter_: string, gatewayManager_: string, contractName_: string, royaltyValue_: BigNumberish, owner_: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        ...
        mintBatch(to: string[], tokenIds: BigNumberish[], overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        mintBatchWithPayload(to: string[], tokenIds: BigNumberish[], payloads: string[], overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        mintWithPayload(to: string, tokenId: BigNumberish, payload: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        ...
        removeFile(fileName: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        renounceOwnership(overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        royaltyInfo(arg0: BigNumberish, value: BigNumberish, overrides?: CallOverrides): Promise<[
            string,
            BigNumber
        ] & {
            receiver: string;
        ...
        setArtistName(artistName_: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        setCollectionName(name_: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        setDescription(description_: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        setGatewayManager(gatewayManager_: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        setLicense(license_: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        setMintingManager(minter_: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        setPayload(tokenId: BigNumberish, payload: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        setRoyalties(royaltyRecipient: string, royaltyValue: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        setURI(newuri: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        setYear(year_: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        _owners(arg0: BigNumberish, overrides?: CallOverrides): Promise<string>;
        _payloads(arg0: BigNumberish, overrides?: CallOverrides): Promise<string>;
        addFile(fileName: string, fileStorageAddresses: string[], overrides?: CallOverrides): Promise<void>;
        ...
        getApproved(tokenId: BigNumberish, overrides?: CallOverrides): Promise<string>;
        getPayload(tokenId: BigNumberish, overrides?: CallOverrides): Promise<string>;
        initialize(uri_: string, minter_: string, gatewayManager_: string, contractName_: string, royaltyValue_: BigNumberish, owner_: string, overrides?: CallOverrides): Promise<void>;
        isApprovedForAll(owner: string, operator: string, overrides?: CallOverrides): Promise<boolean>;
        license(overrides?: CallOverrides): Promise<string>;
        mint(to: string, tokenId: BigNumberish, overrides?: CallOverrides): Promise<void>;
        mintBatch(to: string[], tokenIds: BigNumberish[], overrides?: CallOverrides): Promise<void>;
        mintBatchWithPayload(to: string[], tokenIds: BigNumberish[], payloads: string[], overrides?: CallOverrides): Promise<void>;
        mintWithPayload(to: string, tokenId: BigNumberish, payload: string, overrides?: CallOverrides): Promise<void>;
        mintingManager(overrides?: CallOverrides): Promise<string>;
        name(overrides?: CallOverrides): Promise<string>;
        owner(overrides?: CallOverrides): Promise<string>;
        ownerOf(tokenId: BigNumberish, overrides?: CallOverrides): Promise<string>;
        ...
        setArtistName(artistName_: string, overrides?: CallOverrides): Promise<void>;
        setCollectionName(name_: string, overrides?: CallOverrides): Promise<void>;
        setDescription(description_: string, overrides?: CallOverrides): Promise<void>;
        setGatewayManager(gatewayManager_: string, overrides?: CallOverrides): Promise<void>;
        setLicense(license_: string, overrides?: CallOverrides): Promise<void>;
        setMintingManager(minter_: string, overrides?: CallOverrides): Promise<void>;
        setPayload(tokenId: BigNumberish, payload: string, overrides?: CallOverrides): Promise<void>;
        setRoyalties(royaltyRecipient: string, royaltyValue: BigNumberish, overrides?: CallOverrides): Promise<void>;
    ...
    estimateGas: {
        ...
        _payloads(arg0: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        addFile(fileName: string, fileStorageAddresses: string[], overrides?: Overrides & {
            from?: string;
        }): Promise<BigNumber>;
        approve(to: string, tokenId: BigNumberish, overrides?: Overrides & {
        ...
        fileContents(fileName: string, overrides?: CallOverrides): Promise<BigNumber>;
        fileStorage(fileName: string, overrides?: CallOverrides): Promise<BigNumber>;
        files(overrides?: CallOverrides): Promise<BigNumber>;
        gatewayManager(overrides?: CallOverrides): Promise<BigNumber>;
        getApproved(tokenId: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        getPayload(tokenId: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        initialize(uri_: string, minter_: string, gatewayManager_: string, contractName_: string, royaltyValue_: BigNumberish, owner_: string, overrides?: Overrides & {
            from?: string;
        }): Promise<BigNumber>;
        ...
        royaltyInfo(arg0: BigNumberish, value: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        "safeTransferFrom(address,address,uint256)"(from: string, to: string, tokenId: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<BigNumber>;
        "safeTransferFrom(address,address,uint256,bytes)"(from: string, to: string, tokenId: BigNumberish, data: BytesLike, overrides?: Overrides & {
    ...
    populateTransaction: {
        ...
        _owners(arg0: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        _payloads(arg0: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        addFile(fileName: string, fileStorageAddresses: string[], overrides?: Overrides & {
            from?: string;
        ...
        fileContents(fileName: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        fileStorage(fileName: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        ...
        getPayload(tokenId: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        initialize(uri_: string, minter_: string, gatewayManager_: string, contractName_: string, royaltyValue_: BigNumberish, owner_: string, overrides?: Overrides & {
            from?: string;
        }): Promise<PopulatedTransaction>;
        ...
        projectDescription(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        removeFile(fileName: string, overrides?: Overrides & {
            from?: string;
        }): Promise<PopulatedTransaction>;
        renounceOwnership(overrides?: Overrides & {
        ...
        royaltyInfo(arg0: BigNumberish, value: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        "safeTransferFrom(address,address,uint256)"(from: string, to: string, tokenId: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<PopulatedTransaction>;
        "safeTransferFrom(address,address,uint256,bytes)"(from: string, to: string, tokenId: BigNumberish, data: BytesLike, overrides?: Overrides & {
